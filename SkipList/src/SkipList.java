...
public class SkipList<T extends Comparable<T>> {
    ...
    private class Node<E> {
        ...
        public Node(E key, int lvl) {
            this.key = key;
            this.next = new Node[lvl];
        }
    ...
    public T search(T key) {
        int lvl;
        Node<T> prev, curr;            // find the highest nonnull
    ...
    public void insert(T key) {
        ...
        newNode = new Node(key, lvl + 1); // for newNode;
